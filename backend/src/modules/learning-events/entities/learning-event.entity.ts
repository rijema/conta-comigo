...
export enum LearningEventType {
  ...
  VOICE_COMMAND_UNKNOWN = 'VOICE_COMMAND_UNKNOWN',
  VOICE_HELP_REQUESTED = 'VOICE_HELP_REQUESTED',
  VOICE_INSTRUCTION_REPLAY_REQUESTED = 'VOICE_INSTRUCTION_REPLAY_REQUESTED',
  VOICE_ACTIVITY_CHANGE_REQUESTED = 'VOICE_ACTIVITY_CHANGE_REQUESTED',
}
